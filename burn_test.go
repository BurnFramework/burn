...
func Test_New(t *testing.T) {
	m := New()
	if m == nil {
		t.Error("burn.New() cannot return nil")
	}
}

func Test_Burn_RunOnAddr(t *testing.T) {
	go New().RunOnAddr("127.0.0.1:8080")
}

func Test_Burn_Run(t *testing.T) {
	go New().Run()
}

func Test_Burn_ServeHTTP(t *testing.T) {
	result := ""
...
func Test_Burn_Handlers(t *testing.T) {
	result := ""
	response := httptest.NewRecorder()
...
func Test_Burn_EarlyWrite(t *testing.T) {
	result := ""
	response := httptest.NewRecorder()
...
func Test_Burn_Written(t *testing.T) {
	response := httptest.NewRecorder()
...
func Test_Burn_Basic_NoRace(t *testing.T) {
	m := New()
