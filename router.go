...
// Params is a map of name/value pairs for named routes. An instance of burn.Params is available to be injected into any route handler.
type Params map[string]string

// Router is Burn's de-facto routing interface. Supports HTTP verbs, stacked handlers, and dependency injection.
type Router interface {
	...
	// Handle is the entry point for routing. This is used as a burn.Handler
...
// If you aren't using ClassicBurn, then you can add Routes as a
// service with:
//
//	m := burn.New()
//	r := burn.NewRouter()
//	m.MapTo(r, (*burn.Routes)(nil))
//
// If you are using ClassicBurn, then this is done for you.
...
// Route is an interface representing a Route in Burn's routing layer.
...
// Routes is a helper service for Burn's routing layer.
